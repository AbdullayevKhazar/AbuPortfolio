...
//           <h2 className="text-4xl font-bold tracking-tight text-ink dark:text-soft flex items-center gap-2">
//             Online Presence
//           </h2>
//         </div>
//       </Container>
...
//                   <span className="font-medium text-foreground group-hover:text-primary text-[15px]">
//                     {item.name}
//                   </span>
